...
class PageController extends BaseController
{
    ...
    public function shop_request(Request $request)
    {
        ...
        $shop->save();
        Mail::to("rajmangalrajak4@gmail.com")->send(new ShopRequestNotification($shop));
   ...
   public function search(Request $request)
    {
        ...
        return view('frontend.search-results', compact('products', 'searchQuery'));
    }
}
