                ...
                @foreach ($shops as $shop)
                    <a href="{{ route('shop', $shop->id) }}"
                        ...
                        <div class="relative h-48 bg-gray-200">
                            ...
                            <!-- Shop Type Badge -->
                            <span
                                class="absolute top-2 right-2 bg-red-500 text-white text-xs px-2 py-1 rounded-full">{{ $shop->shop_type }}</span>
                        </div>
        ...
        <div class="container py-14">
            <div>
                <h2 class="text-center text-2xl mb-2">
                    List your  Store at Playpulse Digital Pvt. Ltd.! <br>
                    Reach 1,00,000 + new customers.
                </h2>
            </div>
            <div class=" py-20 grid grid-cols-2 gap-5">
            <div>
                <img class="w-full" src="{{ asset('frontend/images/request.jpg') }}" alt="agreement">
            </div>
            ...
            <div>
                   <form id="form" action="{{ route('shop_request') }}" method="post">
                    ...
                    <div class="space-y-3">
                        <div>
                            <label for="name" class="mb-1">Enter your name <span class="text-[red]">*</span></label>
